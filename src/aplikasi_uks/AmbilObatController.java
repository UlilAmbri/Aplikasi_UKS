 ...
 * @author User
 */
public class AmbilObatController {
    FormAmbilObat view;
    //FormLaporanObat formLaporanObat;
    AmbilObat ambilobat;   //model
    Keluhan keluhan;
    ...
    Connection con;
     ...
     public AmbilObatController(FormAmbilObat view) {
        try {
            this.view = view;
            ...
            Logger.getLogger(AmbilObatController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void clearForm(){
        view.getTxtKodeAmbilObat().setText("");
